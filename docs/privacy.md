...
Codex and guidance install and uninstall keep exact pre-change copies of the
complete target file (`hooks.json` or the selected guidance file). Those files
may contain unrelated hooks, guidance, or secrets. They are stored with mode
`0600` below
